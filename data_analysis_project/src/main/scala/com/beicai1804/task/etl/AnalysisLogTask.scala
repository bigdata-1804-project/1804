...
import com.beicai1804.common.AnalysisLog
import com.beicai1804.config.ConfigurationManager
...
/**
  ...
  * spark-submit --class com.daoke360.task.etl.AnalysisLogTask xxx.jar  2019-04-24
  */
    ...
    try {
      ...
      if (!fileSystem.exists(new Path(inputPath))) {
        throw new SparkException(
          s"""
             |Usage:com.beicai1804.task.etl.AnalysisLogTask
